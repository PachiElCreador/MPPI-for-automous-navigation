        ...
        for y = 1:map_height
            if obstacle_matrix(x, y) == 0 % Only for free cells
                ...
                elseif any(any(obstacle_matrix(x_min4:x_max4, y_min4:y_max4))) % Forth layer
                    cost_map(x, y) = 10; % Forth layer
                elseif any(any(obstacle_matrix(x_min5:x_max5, y_min5:y_max5))) % Fifth layer
                    cost_map(x, y) = 5; % Fifth layer
                end
            end
        end
    end
